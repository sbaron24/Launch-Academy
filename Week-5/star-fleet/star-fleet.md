...
5. Build out (initially failing) **feature tests** for each of your user stories and test drive your app! You can run your tests with the `rspec` command.
6. Finally, write the code that will enable these tests to pass!
